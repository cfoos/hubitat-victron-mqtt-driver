metadata {
    definition(name: "Victron Grid Child", namespace: "cfoos", author: "cfoos") {
...
def installed() {
    logDebug "Installed Victron Grid Child"
}

def updated() {
    logDebug "Updated Victron Grid Child"
}
